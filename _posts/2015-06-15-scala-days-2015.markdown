...
Link to the slides: [http://www.slideshare.net/helenaedelson/lambda-architecture-with-spark-spark-streaming-kafka-cassandra-akka-and-scala](http://www.slideshare.net/helenaedelson/lambda-architecture-with-spark-spark-streaming-kafka-cassandra-akka-and-scala)
...
Composing them together in *for-comprehensions* is not than easy. Consider this code sample from [Erik Bakker](https://twitter.com/eamelink)'s presentation *"Options in Futures, how to unsuck them"*:
...
Link to slides from Erik's workshop: [https://speakerdeck.com/eamelink/flatten-your-code](https://speakerdeck.com/eamelink/flatten-your-code).
